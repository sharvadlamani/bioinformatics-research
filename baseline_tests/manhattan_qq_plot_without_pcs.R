...
data_dir <- "/gpfs/commons/home/svadlamani/skat_all_without_PCs"
...
if (nrow(don) == 0) {
  ...
  if (!is.null(axisdf)) {
    ...
    ggsave("manhattan_plot_without_PCs.png", plot, dpi = 300, width = 20, height = 10)
