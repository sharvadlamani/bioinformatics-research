...
data_dir <- "/gpfs/commons/home/svadlamani/skat_all_without_PRS_5"
...
if (nrow(don) == 0) {
  ...
  if (!is.null(axisdf)) {
    ...
    ggsave("manhattan_plot_without_PRS_5.png", plot, dpi = 300, width = 20, height = 10)
  ...
  pdf("QQ_plots_without_PRS_5.pdf")
